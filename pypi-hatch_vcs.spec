...
Source0  : https://files.pythonhosted.org/packages/6b/b0/4cc743d38adbee9d57d786fa496ed1daadb17e48589b6da8fa55717a0746/hatch_vcs-0.5.0.tar.gz
...
%prep
%setup -q -n hatch_vcs-0.5.0
cd %{_builddir}/hatch_vcs-0.5.0
pushd ..
cp -a hatch_vcs-0.5.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1748354329
